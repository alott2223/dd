...
local themes = {
    Default = {
        ...
        ["Tab Background"] = Color3.fromRGB(45, 45, 45),
...
-- BITCH BOT EXAMPLE
local watermark = library:Watermark("bitch bot | 60 fps | v4.20 | dev")
...
local playerSection = settings:Section{
    Name = "player list",
    Side = "Left"
}

local configSection = settings:Section{
    Name = "configs",
    Side = "Right"
}

local extraSection = settings:Section{
    Name = "extra setting",
    Side = "Right"
}
...
for i, player in ipairs(players) do
    local status = i <= 3 and "Ghosts" or (i <= 6 and "Phantoms" or "None")
    local localPlayer = i == 1 and "Local Player" or "None"
    
    playerSection:Label(player .. " | " .. status .. " | " .. localPlayer)
end

playerSection:Label("page 1 of")
playerSection:Label("no player selected")
...
local bitchbotToggle = extraSection:Toggle{
    Name = "bitchbot 1",
    Flag = "Bitchbot",
    Default = true,
    Callback = function(bool)
        print("Bitchbot is now " .. (bool and "enabled" or "disabled"))
    end
}

local allowfrToggle = extraSection:Toggle{
    Name = "allow fr",
    Flag = "AllowFR",
    Default = false,
    Callback = function(bool)
        print("Allow FR is now " .. (bool and "enabled" or "disabled"))
    end
}

local ragefoToggle = extraSection:Toggle{
    Name = "rage fo",
    Flag = "RageFO",
    Default = false,
    Callback = function(bool)
        print("Rage FO is now " .. (bool and "enabled" or "disabled"))
    end
}
...
legit:Toggle{
    ...
    Flag = "SilentAim",
    Callback = function(bool)
        print("Silent aim is now " .. (bool and "enabled" or "disabled"))
    end
}
...
rage:Toggle{
    ...
    Flag = "AutoShoot",
    Callback = function(bool)
        print("Auto shoot is now " .. (bool and "enabled" or "disabled"))
    end
}
...
visuals:Toggle{
    ...
    Flag = "ESP",
    Callback = function(bool)
        print("ESP is now " .. (bool and "enabled" or "disabled"))
    end
}
...
visuals:Toggle{
    ...
    Flag = "Chams", 
    Callback = function(bool)
        print("Chams is now " .. (bool and "enabled" or "disabled"))
    end
}
...
misc:Toggle{
    ...
    Flag = "AutoReload",
    Callback = function(bool)
        print("Auto reload is now " .. (bool and "enabled" or "disabled"))
    end
}
